...
pi = 1.0/sum([((-1.0)**k)/math.factorial(k) for k in range(0,n)])
print("The approximate value of pi is {0}".format(round(math.pi, decimals)))
print("(The true value of pi is {0})".format(round(math.pi, decimals)))
